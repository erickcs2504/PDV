...
public class ReporteFacturas {
    public void reporteFacturas(Date pFechaUno, Date pFechaDos,String pTotal) throws SQLException, JRException{
        Connection a;
       ...
       // JasperReport reporte=null;
        ...
        JasperReport reporte=(JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/reporteFactura.jasper"));
